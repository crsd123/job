...
import com.conanli.job.jooq_generated.Keys;
...
public class Job extends TableImpl<JobRecord> {
    ...
    /**
     * The column <code>job.JOB_PARAMS</code>. 任务参数
     */
    public final TableField<JobRecord, String> JOB_PARAMS = createField("JOB_PARAMS", org.jooq.impl.SQLDataType.VARCHAR.length(300).defaultValue(org.jooq.impl.DSL.inline("", org.jooq.impl.SQLDataType.VARCHAR)), this, "任务参数");
    ...
    /**
     * The column <code>job.TRIGGER_INTERVAL</code>. 重复执行间隔（毫秒）
     */
    public final TableField<JobRecord, Integer> TRIGGER_INTERVAL = createField("TRIGGER_INTERVAL", org.jooq.impl.SQLDataType.INTEGER.defaultValue(org.jooq.impl.DSL.inline("0", org.jooq.impl.SQLDataType.INTEGER)), this, "重复执行间隔（毫秒）");
    ...
    /**
     * The column <code>job.TRIGGER_START_TIME</code>. 触发器开始时间
     */
    public final TableField<JobRecord, Timestamp> TRIGGER_START_TIME = createField("TRIGGER_START_TIME", org.jooq.impl.SQLDataType.TIMESTAMP.defaultValue(org.jooq.impl.DSL.inline("CURRENT_TIMESTAMP", org.jooq.impl.SQLDataType.TIMESTAMP)), this, "触发器开始时间");

    /**
     * The column <code>job.TRIGGER_STOP_TIME</code>. 触发器结束时间
     */
    public final TableField<JobRecord, Timestamp> TRIGGER_STOP_TIME = createField("TRIGGER_STOP_TIME", org.jooq.impl.SQLDataType.TIMESTAMP, this, "触发器结束时间");
