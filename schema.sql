CREATE DATABASE IF NOT EXISTS `conanli_job` DEFAULT CHARACTER SET utf8;
USE `conanli_job`;
...
CREATE TABLE IF NOT EXISTS `job` (
  ...
  `JOB_PARAMS` VARCHAR(300) DEFAULT '' COMMENT '任务参数',
  ...
  `TRIGGER_START_TIME` DATETIME DEFAULT CURRENT_TIMESTAMP COMMENT '触发器开始时间',
  `TRIGGER_STOP_TIME` DATETIME DEFAULT NULL COMMENT '触发器结束时间',
